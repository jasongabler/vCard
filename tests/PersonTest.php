...
class PersonTest extends PHPUnit_Framework_TestCase {
    ...
    // Test both cases since only $one represents the case of records returned with the 'primary' inner class
...
EOT;
    ...
    public function testParsingMany() {
        
        $records = json_decode($this->many);
        foreach ($records->data as $record) {
            $people[] = new Person($record);
        }
